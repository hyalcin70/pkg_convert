...
sha256sums=('11c9275defe9774472fdcfee7d82b72429aeae5e4768b3fe937ac249722c749c'
            ...
            "$(sha256sum lang/lang_de.cpp | awk '{print $1}')"
            "$(sha256sum lang/lang_en.cpp | awk '{print $1}')"
            "$(sha256sum lang/lang_fr.cpp | awk '{print $1}')"
            "$(sha256sum lang/lang_es.cpp | awk '{print $1}')"
            "$(sha256sum lang/lang_tr.cpp | awk '{print $1}')"
            "$(sha256sum lang/lang_pt.cpp | awk '{print $1}')")

build() {
  cd "$srcdir"
  if [ -d "$srcdir/lang" ]; then
    cp -a "$srcdir/lang/." "$srcdir/"
  fi
